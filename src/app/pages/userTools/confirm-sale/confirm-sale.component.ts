...
export class ConfirmSaleComponent {
  ...
  constructor(
    ...
    this.sale.productsSold = this.sale.productsSold.map((product: { nombre: any; }) => ({
      ...product,
      productName: product.nombre || 'Nombre del producto' // Replace with actual product name if available
    }));
  }
